...
/**
* CarPipelineTwo class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class CarPipelineTwo {
	...
	public void process(Mat source0, Mat source1) {
		...
		// Step HSV_Threshold0:
		Mat hsvThresholdInput = cvAbsdiffOutput;
		double[] hsvThresholdHue = {0.0, 180.0};
		double[] hsvThresholdSaturation = {0.0, 255.0};
		double[] hsvThresholdValue = {33.480215827338135, 255.0};
	...
	private void findBlobs(Mat input, double minArea, double[] circularity,
		...
		FastFeatureDetector blobDet = FastFeatureDetector.create();
		try {
